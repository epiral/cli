...
```
$ ./bin/epiral --agent http://192.168.1.100:8002 --id skywork
2026/02/06 16:02:58 Epiral CLI v0.1.2: id=skywork, agent=http://192.168.1.100:8002
2026/02/06 16:02:58 连接 Agent: http://192.168.1.100:8002
2026/02/06 16:02:58 已注册: skywork (darwin/arm64)
